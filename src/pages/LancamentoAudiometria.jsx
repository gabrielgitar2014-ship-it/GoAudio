...
const LancamentoAudiometria = () => {
  ...
  const handleSaveAudiogram = async (exameData) => {
    ...
    const novoExame = {
      ...
      audiogram_data: exameData.audiogramData,
    };
    await addExame(novoExame);
  };
  
  const columns = [
    { field: 'data_exame', headerName: 'Data do Exame', width: 150, valueGetter: (params) => new Date(params.value).toLocaleDateString('pt-BR', { timeZone: 'UTC' }) },
